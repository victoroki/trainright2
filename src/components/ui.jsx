...
export function PageHero({ eyebrow, title, lead, icon }) {
  return (
    <section className="relative overflow-hidden bg-inverse-surface">
      ...
      />
      <div aria-hidden="true" className="absolute -right-10 -top-16 text-primary/20">
...
export function AdvertBanner({ title, lead, cta = 'Learn more', to = '/work-with-us', icon = 'campaign' }) {
  return (
    <aside className="relative overflow-hidden rounded-xl bg-primary text-on-primary">
      ...
      <div className="relative flex flex-col items-start gap-4 p-6 md:flex-row md:items-center md:justify-between md:p-10">
        ...
        <Link
          to={to}
          className="inline-flex shrink-0 items-center gap-2 rounded bg-white px-5 py-2.5 text-label-lg text-primary transition-colors hover:bg-primary-fixed"
        >
          {cta}
